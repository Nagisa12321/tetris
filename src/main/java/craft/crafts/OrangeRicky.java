 ...
 */
public class OrangeRicky extends AbstractTetrisCraft {

	public OrangeRicky(TetrisModel model, TetrisCraftPoint point1) {
		super(model,
				point1,
				new TetrisCraftPoint(point1.getX() + 1, point1.getY()),
				new TetrisCraftPoint(point1.getX() + 2, point1.getY()),
